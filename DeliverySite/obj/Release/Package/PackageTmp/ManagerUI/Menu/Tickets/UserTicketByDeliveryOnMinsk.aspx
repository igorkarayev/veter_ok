<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMasterPage.master" AutoEventWireup="true" CodeBehind="UserTicketByDeliveryOnMinsk.aspx.cs" Inherits="Delivery.ManagerUI.Menu.Tickets.UserTicketByDeliveryOnMinsk" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3 class="h3custom" style="margin-top: 0;">Заявки Минск</h3>
    <div>
            ...
            <ItemTemplate>
                <asp:TableRow 
                    ...
                    <asp:TableCell id="Td4" runat="server" EnableViewState="False">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"~/ManagerUI/Menu/Tickets/UserTicketEdit.aspx?id=" + OtherMethods.SecureIDOrFullSecureID(Eval("ID").ToString()) + "&page=userticketbydeliveryonminsk&" + OtherMethods.LinkBuilder(stbID.Text, 
                        stbUID.Text, stbRecipientPhone.Text, null,sddlStatus.SelectedValue,sddlDrivers.SelectedValue,stbDeliveryDate1.Text, stbDeliveryDate2.Text, 
    ...
    <div class="floatMenu" style="padding: 5px;">
