<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintMapForManager.aspx.cs" Inherits="Delivery.PrintServices.PrintMapForManager "%>
	...
	<body>
		<div>
			<div style="width: 29.7cm;" class="header">
				Страница печати <b>карты для менеджеров</b>. Все, что следует за кнопкой "Печать" будет распечатано.<hr class="styleHR"/>
					...
					<ItemTemplate>
						<tr id="Tr2" runat="server" style="background-color: #F7F8F9; text-align: center;">
                            ...
                            <td id="Td2" runat="server">
								 <asp:Label ID="Label3"  runat="server" Text='<%# System.Net.WebUtility.HtmlDecode(Eval("Comment").ToString()) %>' />
							</td>
						</tr>
					</ItemTemplate>
				</asp:ListView>
