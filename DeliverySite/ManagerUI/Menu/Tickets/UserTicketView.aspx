<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMasterPage.master" AutoEventWireup="true" CodeBehind="UserTicketView.aspx.cs" Inherits="Delivery.ManagerUI.Menu.Tickets.UserTicketView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
            ...
            if (ok) {
                $.ajax({
                    ...
                    success: function (response) {
                        $('.lblStatus').html("<span style='font-size: 12px; color: green; font-weight: bold'>рассылка поставлена в очередь. <br/>статус отправки сообщений можно просмотреть в личном кабинете <a style=\"font- size: 14px; color: blue;\" href=\"<%= lblStatusSmsSuccess.Value %>\"> личный кабинет</a></span>");
                        $('.lblStatus').show();
        ...
        function ifEnyChecked() {
            var checkboxes = $("table[id*='tableResult'] .selectItem input[type*='checkbox']:checked");//$('#ctl00_MainContent_lvAllTickets_chkboxSelectAll').closest('table').find(':checkbox');
    ...
    <h3 class="h3custom" style="margin-top: 0;">Все заявки</h3>
    <div>
        <asp:Panel runat="server" ID="SearchPanel" CssClass="mainFont" DefaultButton="btnSearch">
            <table class="searchPanel" style="margin-left:auto; margin-right: auto;">
                <tr>
                    ...
                    <td>
                        Тип:<br/>
                        <asp:ListBox runat="server" ID="sddlProfileType" CssClass="searchField multi-control" SelectionMode="Multiple" Height="95px" Width="170px" AccessKey="d"></asp:ListBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align: right;">
                        <asp:Button runat="server" Text="Подтвердить загрузку" CssClass="btn btn-default" ID="btnConfirmUpload"/>
                ...
                <tr>
                    <td colspan="4" style="text-align: left;">
                        ...
                        по
                        <asp:DropDownList runat="server" ID="DropDownListPaging" CssClass="searchField ddl-control" Width="80px"></asp:DropDownList>
                        на стр.
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <div style="width:100%; font-size: 12px;">
                            ...
                            не пробит чек: <asp:CheckBox runat="server" ID="cbNotCheckedOut"/>
                            <div style="width:10px; display:inline-block">&nbsp;</div>
                            не дозвонились: <asp:CheckBox runat="server" ID="cbNotPhoned"/>
                            <div style="width:10px; display:inline-block">&nbsp;</div>
                            счет не выставлен: <asp:CheckBox runat="server" ID="cbNotBilled"/>
                            <div style="width:10px; display:inline-block">&nbsp;</div>
                            только с б/у: <asp:CheckBox runat="server" ID="cbTicketWithOldGoods"/>
                            <div style="width:10px; display:inline-block">&nbsp;</div>
                            не с гл. скл.: <asp:CheckBox runat="server" ID="cbNotFromKalvariiskaia"/>
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        ClientIDRowSuffix="ID" >
            <LayoutTemplate>
                <table id="tableResult" class="tableBorderRadius tableViewClass tableClass colorTable allTickets">
                    <asp:TableRow runat="server">
                        ...
                        <asp:TableHeaderCell runat="server" ID="CellTableND">
                           HД
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server"  class="thIsVisibleUserProfile" ID="CellTableProfile">
                            Профиль
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" style="width: 140px;" ID="CellTableGoods">
                            Грузы
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableKK">
                            КК
                        </asp:TableHeaderCell>
                        
                        <asp:TableHeaderCell runat="server" ID="CellTableSendFrom">
                            Отпр. из
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableDirection">
                            Нпр.
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableRecieverCity">
                            Город получ.
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" style="width: 120px;" ID="CellTableRecieverAddr">
                            Адр. получателя
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" style="width: 110px;" ID="CellTableReciever">
                            Получатель
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableNotes">
                            Примечания
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableComments">
                            Комментарии
                        </asp:TableHeaderCell>
                        
                        <asp:TableHeaderCell runat="server" ID="CellTableOtherOptions">
                            Дополнит. опции
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableRecieveDate">
                        ...
                        <asp:TableHeaderCell runat="server" ID="CellTableSendDate">
                        ...
                        <asp:TableHeaderCell runat="server" ID="CellTableStatus">
                        ...
                        <asp:TableHeaderCell runat="server" ID="CellTableDID">
                            <asp:LinkButton runat="server" Text="DID" ID="LinkButton1" CommandArgument="DriverID" OnClick="lvAllTickets_OnSortingButtonClick"/>
                        </asp:TableHeaderCell>
                        
                        <asp:TableHeaderCell runat="server" ID="CellTableAgreedCost">
                            Оцен/Согл
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableCost">
                            За услугу
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTablePN">
                            ПН
                        </asp:TableHeaderCell>

                        <asp:TableHeaderCell runat="server" ID="CellTableWeight">
                            Вес
                        </asp:TableHeaderCell>
            ...
            <ItemTemplate>
                <asp:TableRow 
                    runat="server" 
                    CssClass='<%# String.Format("{0} {1} {2} {3} {4}", 
                                    ...
                                    OtherMethods.RedClientTrClass(Convert.ToInt32(Eval("UserID"))),
                                    TicketsHelper.SelectIfBilled(Eval("Billed").ToString())) %>'>
                    ...
                    <asp:TableCell ID="Td7" runat="server">
                                                 ...
                                                 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"~/ManagerUI/Menu/Tickets/UserTicketEdit.aspx?id=" + OtherMethods.SecureIDOrFullSecureID(Eval("ID").ToString()) + "&page=userticketsview&" + OtherMethods.LinkBuilder(stbID.Text, 
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableUID == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td3" runat="server"  EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableND == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell6" runat="server" EnableViewState="False">
                                                 <grb:PrintNaklInMap 
                                                     ID="PrintNaklInMap" 
                                                      runat="server" 
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableProfile == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell1" runat="server" EnableViewState="False" Visible="<%# IsVisibleUserProfile %>">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableGoods == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td10" runat="server" EnableViewState="False">
                        <grb:GoodsList 
                            ID="GoodsList" 
                            runat="server" 
                            TicketID='<%# Eval("ID").ToString() %>'
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableKK == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td12" runat="server" EnableViewState="False">
                        <asp:Label ID="Label8" runat="server" Text='<%#Eval("BoxesNumber") %>' />
                    </asp:TableCell>
                    
                    <asp:TableCell CssClass='<%# UserRoles.TableSendFrom == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell10" runat="server" EnableViewState="False">
                        <grb:SenderAddress 
                            ID="SenderAddress" 
                            runat="server" 
                            TicketID='<%# Eval("ID").ToString() %>'
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableDirection == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td8" runat="server" EnableViewState="False">
                        <asp:Label ID="Label3" runat="server" Text='<%# CityHelper.CityToTrack(Convert.ToInt32(Eval("CityID")), Eval("ID").ToString()) %>' />
                    </asp:TableCell>
                    
                    <asp:TableCell CssClass='<%# UserRoles.TableRecieverCity == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td5" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableRecieverAddr == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td2" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableOtherOptions == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell9" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableRecieveDate == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td14" runat="server" EnableViewState="False">
                        <asp:Label ID="Label11" runat="server" Text='<%# OtherMethods.DateConvert(Eval("AdmissionDate").ToString()) %>' />
                    </asp:TableCell>

                    <asp:TableCell CssClass='<%# UserRoles.TableSendDate == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td0" runat="server" EnableViewState="False">
                        <asp:Label ID="lblDeliveryDate" runat="server" Text='<%# OtherMethods.DateConvert(Eval("DeliveryDate").ToString()) %>' />
                    </asp:TableCell>
                    
                    <asp:TableCell CssClass='<%# UserRoles.TableStatus == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td1" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableDID == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td13" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%#String.Format("{0} {1}", OtherMethods.DisplayHelper(UserRoles.TableAgreedCost).ToString(), MoneyMethods.AgreedAccessedCostOver100BazVelich(MoneyMethods.AgreedAssessedCosts(Eval("ID").ToString()))) %>' id="TableCell7" runat="server" EnableViewState="False">
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableCost == 1 ? "displayColumn" : "notDisplayColumn" %>' id="Td16" runat="server" EnableViewState="False">
                        <grb:GruzobozCost 
                            ID="GruzobozCost" 
                            runat="server" 
                            TicketID='<%# Eval("ID").ToString() %>'
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TablePN == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell4" runat="server" EnableViewState="False">
                        <grb:PrintNakl 
                            ID="PrintNakl" 
                            runat="server" 
                            TicketID='<%# Eval("ID").ToString() %>' 
                    ...
                    <asp:TableCell CssClass='<%# UserRoles.TableWeight == 1 ? "displayColumn" : "notDisplayColumn" %>' id="TableCell5" runat="server" EnableViewState="False">
                        <grb:Weight 
                            ID="Weight" 
                            runat="server" 
                            TicketID='<%# Eval("ID").ToString() %>'
        ...
        <div class="infoBlock" style="margin-bottom: 0;">
            <div class="pager">
                ...
                <asp:DataPager ID="lvDataPager" runat="server" PagedControlID="lvAllTickets" EnableViewState="false">
                    <Fields>
    ...
    <div class="floatMenuRight floatCity" style="width: 700px; max-height: 500px; overflow: auto;">
        ...
        <asp:Panel runat="server" ID="pnlSendSms" style="font-weight: normal; font-size: 10px; padding: 10px; display: inline-block; width: 23%; float: left" Visible="False">
            <div onclick="SendSmsAjaxRequest(); return false;" class="btn btn-default" style="width: 100%;  font-size: 12px; white-space:normal; text-align: center; border: 1px solid #ccc">Отправить СМС-рассылку получателям</div>
    ...
    <div class="floatMenuLeft lblStatus" style="margin-left: 0">
        ...
        <asp:HiddenField runat="server" ID="lblStatusSmsSuccess"/>
    </div>
