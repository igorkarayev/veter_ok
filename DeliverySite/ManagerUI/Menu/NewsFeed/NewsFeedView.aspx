<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMasterPage.master" AutoEventWireup="true" CodeBehind="NewsFeedView.aspx.cs" Inherits="Delivery.ManagerUI.Menu.NewsFeed.NewsFeedView" %>
                    ...
                    <tr id="Tr2" runat="server">
                        <td>
                            <div style="font-size: 18px; width: 100%; ">
                                ...
                                <asp:HyperLink ID="HyperLink1" CssClass="blueTitle" runat="server" NavigateUrl='<%#"~/ManagerUI/Menu/NewsFeed/NewsFromFeedView.aspx?title="+Eval("TitleUrl") %>'>
                            ...
                            <div style="width: 100%; text-align: justify;">
                                ...
                                <span id="Span2" style="width: 100%; text-align: right; margin-top: 8px; float: right;" runat="server" Visible='<%# OtherMethods.ReadMoreVisible(Eval("Body").ToString()) %>'>
                                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%#"~/ManagerUI/Menu/NewsFeed/NewsFromFeedView.aspx?title="+Eval("TitleUrl") %>'>читать дальше...</asp:HyperLink>
                                </span>
                            </div>
