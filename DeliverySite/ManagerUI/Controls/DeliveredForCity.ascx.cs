...
{
    public partial class DeliveredForCity : System.Web.UI.UserControl
    {
        ...
        public string OvdFrom
        {
            get
            {
                return (ViewState["OvdFrom"] != null && !String.IsNullOrEmpty(ViewState["OvdFrom"].ToString())) ? Convert.ToDateTime(ViewState["OvdFrom"].ToString()).ToString("HH:mm") : String.Empty;
            }
            set
            {
        ...
        public string OvdTo
        {
            get
            {
                return (ViewState["OvdTo"] != null && !String.IsNullOrEmpty(ViewState["OvdTo"].ToString())) ? Convert.ToDateTime(ViewState["OvdTo"].ToString()).ToString("HH:mm") : String.Empty;
            }
            set
            {
