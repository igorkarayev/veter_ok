...
namespace DeliverySite.PrintServices.Controls
{
    public partial class ChangeBoxesNumber : System.Web.UI.UserControl
    {
        ...
        public string Boxes
        {
            get
            {
                return ViewState["Boxes"] != null ? ViewState["Boxes"].ToString() : String.Empty;
            }
            set
            {
                ViewState["Boxes"] = value;
            }
        }
