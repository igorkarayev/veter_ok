...
{
    public partial class WeightToPril2 : System.Web.UI.UserControl
    {
        ...
        public string Pril2Weight
        {
            get
            {
                return ViewState["Pril2Weight"] != null ? ViewState["Pril2Weight"].ToString() : String.Empty;
            }
            set
            {
                ViewState["Pril2Weight"] = value;
            }
        }
        ...
        public string Weight
        {
            get
            {
                return ViewState["Weight"] != null ? ViewState["Weight"].ToString() : String.Empty;
            }
            set
            {
